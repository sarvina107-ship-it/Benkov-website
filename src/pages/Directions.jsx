  ...
  return (
    <section className="pt-16 sm:pt-20 md:pt-24 bg-[#F4F2EE] dark:bg-gray-950 text-[#1A1A1A] dark:text-gray-100" id="art-directions">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center mb-12 sm:mb-16 md:mb-20">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4 sm:mb-6 text-[#0E1A2B] dark:text-gray-100">
        ...
        <div className="w-16 sm:w-20 md:w-24 h-1 bg-[var(--gold-primary)] mx-auto mt-6 sm:mt-8 rounded-full"></div>
      </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-[#F4F2EE] dark:bg-gray-950 border-t border-[var(--gold-primary)]/10 dark:border-[var(--gold-primary)]/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="bg-white dark:bg-gray-900 rounded-[24px] sm:rounded-[28px] md:rounded-[30px] p-6 sm:p-8 md:p-12 shadow-inner border border-[var(--gold-primary)]/10 dark:border-[var(--gold-primary)]/5 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 relative z-10">
              {/* Иконка */}
              <div className="flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#F4F2EE] dark:bg-gray-800 flex items-center justify-center border-4 border-white dark:border-gray-700 shadow-lg">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="var(--gold-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex-shrink-0">
                <Link to={ROUTES.CONDITIONS}>
                  <button className="group relative px-5 sm:px-6 md:px-8 lg:px-10 py-2.5 sm:py-3 md:py-4 bg-[#1B2A44] dark:bg-gray-800 text-white rounded-xl font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-xs sm:text-sm border border-[var(--gold-primary)]/30 hover:border-white transition-all duration-300">
