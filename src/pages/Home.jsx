  ...
  return (
    <PageWrapper>
      ...
      <div>
        ...
        >
          {/* Центрированное золотистое свечение на фоне */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 sm:w-[500px] h-80 sm:h-[500px] bg-[var(--gold-primary)]/10 dark:bg-[var(--gold-primary)]/5 rounded-full blur-[160px] pointer-events-none"></div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mb-6 sm:mb-8 flex flex-col items-center">
                <div className="flex items-center gap-3 sm:gap-4 mb-4">
                  <span className="w-6 sm:w-10 h-[1px] bg-[var(--gold-primary)]"></span>
                ...
                <h2
                  ...
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  {t('home.director.title_part1')}{' '}
                  <span className="text-[var(--gold-primary)]">{t('home.director.title_part2')}</span>
                </h2>

                <h3
                  className="text-lg sm:text-xl md:text-2xl font-medium text-[var(--gold-primary)]/90 italic"
                  style={{ fontFamily: "'Merriweather', serif" }}
                >
              ...
              {/* Карточка с цитатой */}
              <div className="relative w-full my-6 sm:my-8 p-6 sm:p-10 md:p-12 rounded-2xl bg-white/[0.02] dark:bg-white/[0.01] border border-[var(--gold-primary)]/20 backdrop-blur-sm shadow-2xl">
                {/* Иконка кавычек по центру сверху */}
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-[#0B1524] dark:bg-black border border-[var(--gold-primary)]/40 flex items-center justify-center">
                  <span className="text-[var(--gold-primary)] font-serif text-3xl leading-none">“</span>
                </div>

                <p
                  className="text-gray-300 dark:text-gray-300 text-base sm:text-lg md:text-xl leading-[1.7] sm:leading-[1.9] italic"
                  style={{ fontFamily: "'Merriweather', serif" }}
                >
                  {t('home.director.quote')}
                </p>

                {/* Декоративный штрих снизу карточки */}
                <div className="w-16 h-[2px] bg-gradient-to-r from-transparent via-[var(--gold-primary)] to-transparent mx-auto mt-6 sm:mt-8 opacity-60"></div>
              </div>
        ...
        {/* --- Почему выбирают нас --- */}
        <section
          className="py-16 sm:py-24 md:py-32 bg-white dark:bg-gray-950 relative overflow-hidden opacity-0 translate-y-10 transition-all duration-1000 ease-out"
          ref={el => sectionsRef.current[4] = el}
        >
          {/* Декоративное свечение на фоне */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-[var(--gold-primary)]/5 rounded-full blur-[120px] pointer-events-none"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            <div className="text-center mb-12 sm:mb-16 md:mb-20">
              <h2
                className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1B2A44] dark:text-gray-100 mb-4"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
              ...
              <div className="flex justify-center items-center gap-3">
                <span className="w-8 sm:w-12 h-[1px] bg-[var(--gold-primary)]/40"></span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              {/* Карточка 1 */}
              <div className="relative group bg-[#FAF9F6]/60 dark:bg-gray-900/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-[var(--gold-primary)]/15 dark:border-[var(--gold-primary)]/10 hover:border-[var(--gold-primary)]/50 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl">
                <div className="absolute top-6 right-6 text-3xl sm:text-4xl font-serif text-[var(--gold-primary)]/30 font-bold group-hover:text-[var(--gold-primary)] transition-colors duration-300">
                  01
                </div>
                <div>
                  <h3
                    className="text-xl sm:text-2xl font-bold text-[#1B2A44] dark:text-gray-100 mb-3 pr-12"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    {t('home.benefits.items.one.title')}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base leading-relaxed font-serif mb-6">
                    {t('home.benefits.items.one.desc')}
                  </p>
                </div>
                <ul className="flex flex-col sm:flex-row gap-2 sm:gap-4 pt-4 border-t border-[var(--gold-primary)]/10">
                  <li className="flex items-center gap-2 text-xs sm:text-sm text-[#1B2A44]/80 dark:text-gray-400">
              ...
              <div className="relative group bg-[#FAF9F6]/60 dark:bg-gray-900/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-[var(--gold-primary)]/15 dark:border-[var(--gold-primary)]/10 hover:border-[var(--gold-primary)]/50 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl">
                ...
                <div className="flex flex-wrap gap-2 pt-4 border-t border-[var(--gold-primary)]/10">
                  <span className="px-3 py-1 bg-white dark:bg-gray-800 border border-[var(--gold-primary)]/20 rounded-full text-[10px] sm:text-xs text-[var(--gold-primary)] font-bold tracking-wider uppercase">
            ...
            <div className="mt-12 sm:mt-16 text-center">
              <Link to={ROUTES.ACHIEVEMENTS}>
                <button className="group relative px-6 sm:px-8 md:px-10 py-3.5 sm:py-4 bg-[var(--gold-primary)] text-white rounded-xl font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-xs sm:text-sm border border-[var(--gold-primary)]/30 hover:border-[#1B2A44] dark:hover:border-gray-700 transition-colors duration-300 shadow-md">
