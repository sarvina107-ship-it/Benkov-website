          ...
          <div className="sm:col-span-1 lg:col-span-2">
            ...
            <div className="flex gap-3 sm:gap-4 justify-center sm:justify-start">
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg border border-[#D4A259]/30 flex items-center justify-center hover:bg-[#D4A259] hover:border-[#D4A259] hover:-translate-y-1 transition-all duration-300 group"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4A259] group-hover:text-[#0B1524] transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a
                href="https://www.instagram.com/benkov_maktabi?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg border border-[#D4A259]/30 flex items-center justify-center hover:bg-[#D4A259] hover:border-[#D4A259] hover:-translate-y-1 transition-all duration-300 group"
              >
